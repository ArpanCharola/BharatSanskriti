...
export default function TraditionsList() {
  ...
  const perPage = 3; // 🔹 Show 3 at a time

  // Get current page from URL or session storage, default to 1
  const currentPageFromUrl = parseInt(searchParams.get("page") || sessionStorage.getItem("traditionsPage") || "1");
  ...
  useEffect(() => {
    ...
    axios
      .get("http://localhost:5000/api/traditions")
